...
def fifoOrdering(list: List[SoporteTiquete]) -> List[SoporteTiquete]:
    return list.copy()


def filoOrdering(list: List[SoporteTiquete]) -> List[SoporteTiquete]:
    list_copy = list.copy()
    list_copy.reverse()
    return list_copy


def randomOrdering(list: List[SoporteTiquete]) -> List[SoporteTiquete]:
    list_copy = list.copy()
    random.shuffle(list_copy)
    return list_copy


def blackHoleOrdering(list: List[SoporteTiquete]) -> List[SoporteTiquete]:
    return []
...
class SoporteCliente:
    ...
    def process_tickets(self, ordering: Callable[[List[SoporteTiquete]], List[SoporteTiquete]]):
